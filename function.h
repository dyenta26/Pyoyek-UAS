...
//Function untuk mengurutkan dari Negara termiskin hingga terkaya

//linkedList on sorting 
...
void menu(negara Negara[100], mahasiswa Mahasiswa){
	...
	do{
        ...
        printf("\n\n");
        printf("================================================================================\n");
	    printf("              Program untuk menampilkan negara terNegara di dunia\n");
        ...
        printf("3. Urutan daftar negara terNegara di dunia berdasarkan GDP per kapita\n");
        ...
        switch (pilihan){
			...
			case 2: do {
                	...
                	//Pilihan untuk mengulang lagi menu
	                printf("\n\npakah mau mencari Urutan negara yang lain\n");
    	            printf("1. Ya\t2. Tidak \n\nPilihan : ");
        	        scanf("%d", &ulang);
            	    system ("CLS");
               		} while (ulang != 2);
